...
pub mod map;
pub use map::Map;
// use crate::map::floor::Floor;

pub mod door;
pub use door::DoorNode;
...
// use crate::enemy::EnemyClass;
// use crate::enemy::{EnemyData, Goblin};
// use crate::map::Door;
// use crate::utils::{Dir2i, Dir3, assets, load_resource, load_scene_as};
...
//         let mut map = Gd::from_init_fn(|base| Self {
//             base,
//             width,
//             height,
//             s_coords: Vector2i {
...
//         if let Some(data) = self.get_cell_data(coords) {
//             for enemie in data.enemies.iter() {
//                 let enemie = enemie.turn_to_life();
//                 enemie.clone().add_to_group("enemies");
//             }
//         }
//         room
//     }

//     pub fn room_to_data(&mut self, coords: Vector2i) {
//         if self.coords_is_ok(coords) {
//             let enemies = self.base().get_tree().get_nodes_in_group("enemies");

//             let data = self.get_cell_mut_data(coords).unwrap();
//             data.enemies = vec![];

//             for mut node in enemies.iter_shared() {
//                 if let Ok(goblin) = node.clone().try_cast::<Goblin>() {
//                     data.enemies.push(goblin.bind().to_data());
//                 }
//                 node.queue_free();
//             }
//         }
...
//         Vector3::new(
//             self.s_coords.x as f32 + 0.5,
//             1.2,
//             self.s_coords.y as f32 + 0.5,
//         )
//     }
...
//     fn get_cell_data(&self, coords: Vector2i) -> Option<&CellData> {
//         if self.coords_is_ok(coords) {
//             self.grid[coords.y as usize][coords.x as usize]
//                 .data
//                 .as_ref()
